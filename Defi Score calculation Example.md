...
**P1 Query** \- [https://ide.bitquery.io/v1-query---transaction-count-for-an-address-last-3-yrs](https://ide.bitquery.io/v1-query---transaction-count-for-an-address-last-3-yrs)  
...
{
"time3yr_ago":"2022-12-17T00:00:00Z",
"address":"0x0F9DFd170F6d3109F801F1475b11a9c135232538"
}

Tx Count \- 86  
P1 Score \- 84.44 points

**P2 & P3 Query** \- [https://ide.bitquery.io/v1-query---Calls-to-Different-types-of-protocols-for-last-3-yrs](https://ide.bitquery.io/v1-query---Calls-to-Different-types-of-protocols-for-last-3-yrs)
...
1. **DEXSwaps, NFT Trading** \- separate query \- [https://ide.bitquery.io/v2-query---dexswaps-and-nft-trading-activity--for-last-3-yrs](https://ide.bitquery.io/v2-query---dexswaps-and-nft-trading-activity--for-last-3-yrs)  
...
5. **Governance** \- separate query \- [https://ide.bitquery.io/governance-check-for-an-address_1](https://ide.bitquery.io/governance-check-for-an-address_1)  
   query MyQuery($address: String) {  
...
**P4 Query** \- NFT Balances \- [https://ide.bitquery.io/NFT-balances-of-an-address_1](https://ide.bitquery.io/NFT-balances-of-an-address_1)  
query MyQuery {  
...
Token ERC-20 Token Balances \- [https://ide.bitquery.io/Token-balances-of-an-address-above-10_1](https://ide.bitquery.io/Token-balances-of-an-address-above-10_1)  
{  
 EVM(network: eth, dataset: combined) {  
 BalanceUpdates(  
